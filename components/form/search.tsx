        ...
        <div className="flex flex-col relative dark:text-white" ref={skillsRef}>
            ...
            <div className="relative flex-1">
                ...
                <input
                    ...
                    value={searchTerm}
                    className="bg-white dark:bg-zinc-800 border-gray-300 dark:border-zinc-700 py-2 pl-10 w-full rounded-md focus:outline-none border shadow-md focus:border-red-500 focus:ring-red-500"
