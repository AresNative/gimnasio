        ...
        <div className="flex flex-col">
            ...
            >
                ...
                <label
                    ...
                    className=" bg-white dark:bg-zinc-800 py-2 px-3 border border-gray-300  dark:border-zinc-700 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 cursor-pointer"
                >
